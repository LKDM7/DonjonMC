...
public class RankBFrostSpell extends AbstractSpell {
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(
            Component.translatable("spell.donjonmc.rank_b_frost.desc"),
            Component.translatable("ui.irons_spellbooks.damage", Utils.stringTruncation(6f + spellLevel * 4f, 1)),
            Component.translatable("ui.irons_spellbooks.radius", (int) (8.0 + spellLevel * 2.0)),
            Component.translatable("ui.irons_spellbooks.slowness_effect", Math.min(1 + spellLevel, 5) + 1),
